<div class="<?php echo esc_attr( $this->plugin_name ); ?>__content">
	...
	<?php else: ?>
		<?php do_action( 'feedaty_fwr__before_product_badge' ); ?>
        <div class="<?php echo esc_attr( $this->plugin_name ); ?>-settings-form container clearfix">
            <form method="post" name="<?php echo esc_attr( $this->plugin_name ); ?>_options" action="options.php" class="feedaty_badges">
				<?php
					settings_fields( $this->plugin_name );
					do_settings_sections( $this->plugin_name );
					do_action( 'feedaty_fwr__product_badge' );
				?>
				<?php submit_button( __('Save all changes', $this->plugin_name), 'primary', 'submit', true ); ?>
            </form>
        </div>
		<?php do_action( 'feedaty_fwr__after_product_badge' ); ?>
	<?php endif; ?>
